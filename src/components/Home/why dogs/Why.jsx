  ...
  return (
    <section className='why'>
                ...
                <div className="why-con"  >
                    <img src={require('/Users/ELCOT/reactproject/OnlyDogs/src/components/assets/why2-c.jpg')} data-aos="fade-up" alt="" /> 
                    <div className="points" data-aos="fade-up">
                        <p>
                            <img src={require('/Users/ELCOT/reactproject/OnlyDogs/src/components/assets/paw.png')} alt="" />
